...
BOT_TOKEN = environ['6761188489:AAGqRuXzvxiYwEaL3JCWi9LgDrYONSmoWq0']
...
AUTH_CHANNEL = [int(auth_channel) for auth_channel in environ.get('AUTH_CHANNEL', '-1001908798887').split() if id_pattern.search(auth_channel)]
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001519086789')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001908798887')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = is_enabled((environ.get("NO_RESULTS_MSG", 'False')), False)

# MongoDB information
SECONDDB_URI = environ.get('SECONDDB_URI', "mongodb+srv://wayik41893:wayik41893@cluster0.cprtcvp.mongodb.net/?retryWrites=true&w=majority")
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', "https://t.me/c/1558295026/51")
VERIFY2_URL = environ.get('VERIFY2_URL', "gplinks.com")
VERIFY2_API = environ.get('VERIFY2_API', "1363e5dd5ec8084dd9df83fcb53d436870c93cf1")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001519086789'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001519086789')).split()]
